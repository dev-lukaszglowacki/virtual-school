...
public class LessonPlanService {
    ...
    public ResponseEntity<LessonPlan> createLessonPlan(@NonNull CreateLessonPlanDTO lessonPlanDetails) {
    ...
    public ResponseEntity<LessonPlan> updateLessonPlan(@NonNull Long id, @RequestBody UpdateLessonPlanDTO lessonPlanDetails) {
    ...
    public ResponseEntity<Void> deleteLessonPlan(@NonNull Long id) {
        return lessonPlanRepository.findById(id)
            .map(lessonPlan -> {
